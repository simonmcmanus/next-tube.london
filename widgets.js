  ...
  tflStatus: {
    ...
    selectors: function(data) {
      var newData = data.map(function(line) {
        ...
        var out = '<li class="line ' + line.CssClass + ' ' + line.Line.Name.replace(/ /g, '')+ '"><div class="circle"></div><div class="name">' + line.Line.Name + '</div><div><small>' + line.StatusDetails.replace(/\n/g, '</br>') + '</small></div></li>';
        return out;
