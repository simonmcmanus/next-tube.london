...
exports.init = function(stationCode, direction, position, $el, bus) {
    console.log('init train', stationCode + '.trains.' + direction + '[' + position + ']');
...
function valueChange($el, bus, change) {
        debugger;
